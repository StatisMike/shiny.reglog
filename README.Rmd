...
more secure but the setup can be more tricky: for more information you can check
vignette: [shiny.reglog: How to get Google API authorization](https://cran.r-project.org/web/packages/shiny.reglog/vignettes/auth.html){target="_blank"}
