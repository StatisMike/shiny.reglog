...
Basic information about *shiny.reglog* is contained within this document. There
are some more resources to learn about its usage:
...
*MongoDB* is very popular NoSQL database with pretty low entry-point. Connector
is still experimental.

Setup is analogous to other database connectors. For more informations, refer
to documentation: `?mongo_tables_create()`, `?RegLogMongoConnector`
