...
-   [How to use gargle for auth in a client package](https://cran.r-project.org/web/packages/gargle/vignettes/gargle-auth-in-client-package.html)
...
Security shouldn't be a problem on [shinyapps.io](https://shinyapps.io), but if you are deploying Shiny-Server yourself, remember to secure it - ideally make it available only for the **shiny** user.
