...
RegLog_txts$en = list(
  ...
  ### credsEdit modals ####
  credsEdit_notLogged_t = "Not logged in",
  credsEdit_notLogged_b = "To change any credentials you need to be logged in.",
  credsEdit_noInput_pass_t = "Missing data",
  credsEdit_noInput_pass_b = "To change you password, please provide your current password alongside new password.",
  credsEdit_noInput_other_t = "Missing data",
  credsEdit_noInput_other_b = "To change your user ID and/or email, please provide your current password alongside new user ID and/or email.",
  ...
  cred_edit_ui_p_old = "As you are going to edit your information, please provide your current password below to confirm your identity before trying to trigger any changes.",
...
RegLog_txts$pl = list(
  ...
  ### credsEdit modals ####
  credsEdit_notLogged_t = "Nie zalogowano",
  credsEdit_notLogged_b = "Jedynie zalogowany u\u017Cytkownik mo\u017Ce zmieni\u0107 swoje dane.",
  credsEdit_noInput_pass_t = "Brakuj\u0105ce dane",
  credsEdit_noInput_pass_b = "Aby zmieni\u0107 has\u0142o, prosz\u0119 poda\u0107 zar\u00F3wno obecne jak i nowe has\u0142o..",
  credsEdit_noInput_other_t = "Brakuj\u0105ce dane",
  credsEdit_noInput_other_b = "Aby zmieni\u0107 nazw\u0119 u\u017Cytkownika i/lub e-mail, prosz\u0119 poda\u0107 obecne has\u0142o oraz now\u0105 nazw\u0119 u\u017Cytkownika i/lub e-mail.",
  ...
  cred_edit_ui_p_old = "Przed zatwierdzeniem jakichkolwiek zmian, prosz\u0119 o potwierdzenie swojej to\u017Csamo\u015Bci z wykorzystaniem obecnego nazwy has\u0142a.",
